...
(library Library_1
	...
	(compDef "TL431LIBEDBZRQ1" (originalName "TL431LIBEDBZRQ1") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "REF") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "ANODE") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.ti.com/lit/gpn/TL431LI-Q1")
		(attr "<Component Height>" "1.12")
		(attr "<STEP Filename>" "TL431LIBEDBZRQ1.stp")
